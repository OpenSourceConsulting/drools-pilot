...
set "JAVA_OPTS=%JAVA_OPTS% -Dcom.sun.management.jmxremote.port=3331"
set "JAVA_OPTS=%JAVA_OPTS% -Dcom.sun.management.jmxremote.ssl=false"
set "JAVA_OPTS=%JAVA_OPTS% -Dcom.sun.management.jmxremote.authenticate=false"

"%VDIP_JAVA%" -cp lib/hsqldb-2.3.3.jar %JAVA_OPTS% org.hsqldb.server.Server --database.0 mem:nicedb --dbname.0 nicedb
